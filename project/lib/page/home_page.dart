...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    _studentDataSubscription =
        StudentDataDocumentManager.instance.startListening(
    ...
    showDialog(
        ...
        builder: (context) {
          usernameTextController.text =
              StudentDataDocumentManager.instance.displayName;
          ...
          academicStandingtextController.text =
              StudentDataDocumentManager.instance.academic;
